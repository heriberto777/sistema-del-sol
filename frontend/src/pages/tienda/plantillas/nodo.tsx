      ...
      <div className="mx-auto grid max-w-4xl gap-10 px-6 py-12 sm:grid-cols-2 sm:px-10">
        ...
        <div>
          ...
          <BotonWhatsAppProducto
            ...
            className="mt-3 flex w-full items-center justify-center gap-2 rounded-lg border border-[color:var(--tienda-color-texto)]/15 px-6 py-3 text-[0.85em] font-semibold"
          />
        </div>
      </div>
