...
const ENLACES_MENU: Record<ClaveMenuTienda, { label: string; href: (subdominio: string) => string }> = {
  ...
  categorias: { label: 'Drops', href: (s) => `/tienda/${s}/productos` },
      ...
      <div className="mx-auto grid max-w-4xl gap-10 px-6 py-12 sm:grid-cols-2 sm:px-10">
        ...
        <div>
          ...
          <BotonWhatsAppProducto
            ...
            className="mt-3 flex w-full items-center justify-center gap-2 border border-[color:var(--tienda-color-texto)]/15 px-6 py-3 text-[0.85em] font-bold uppercase tracking-[0.03em] text-[var(--tienda-color-texto)]"
          />
        </div>
      </div>
