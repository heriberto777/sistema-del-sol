  ...
  return (
    <div className="flex flex-wrap items-center gap-x-6 gap-y-2 px-6 py-3 sm:px-10" style={{ background: HEADER_BG }}>
      ...
      <div className="ml-auto flex flex-wrap items-center justify-end gap-3 gap-y-2 sm:gap-5">
        ...
        <ToggleTemaTienda className="text-white/85" />
      </div>
    </div>
  );
}
      ...
      >
        <div className="relative ml-auto min-w-[220px] flex-1 sm:max-w-sm">
          ...
          <input
            ...
            className="w-full rounded bg-[var(--tienda-color-superficie)] py-1.5 pl-8 pr-3 text-[0.8em] text-[var(--tienda-color-texto)] outline-none"
          />
        </div>
      </form>
