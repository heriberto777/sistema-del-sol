...
function Nav({ nombre, logo, subdominio, cantidadCarrito, menu }: { nombre: string; logo: string | null; subdominio: string; cantidadCarrito: number; menu: ClaveMenuTienda[] }) {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-y-2 bg-[var(--tienda-color-superficie)] px-6 py-4 shadow-sm sm:px-10">
...
function OficioHome({ config, subdominio, carrito }: PropsHome) {
