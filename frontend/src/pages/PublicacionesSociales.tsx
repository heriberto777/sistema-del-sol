...
export function PublicacionesSociales() {
  ...
  const crear = useMutation({
    mutationFn: async () =>
      (await apiClient.post('/admin/publicaciones-sociales', { productoId: productoSeleccionado?.id, plantillaId })).data as PublicacionSocialResumen,
    onSuccess: (creada) => {
              ...
              <tbody>
                {publicaciones.map((p) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-slate-600 dark:text-slate-300">{p.plantilla.nombre}</td>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="font-medium text-slate-900 dark:text-slate-100">{publicacion.plantilla.nombre}</p>
            </div>
            <div>
