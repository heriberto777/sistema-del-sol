...
export const ROLES_PLATAFORMA_BASE: Record<string, string[]> = {
  ...
  Ventas: ['platform.tenants.ver', 'platform.tenants.crear', 'platform.tenants.gestionar', 'platform.planes.ver'],
  Soporte: ['platform.tenants.ver', 'platform.planes.ver', 'platform.auditoria.ver'],
};
